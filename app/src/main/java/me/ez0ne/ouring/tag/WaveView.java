...
public class WaveView extends View {
    ...
    private int mWaterColor = 0xFFD9D9D9;
    ...
    public void setRunning(int name) {


        switch (name){
            case 1:mWaterColor = 0xFFD9D9D9;break;
            case 2:mWaterColor = 0xFF35C8E6;break;
            default:break;
        }
