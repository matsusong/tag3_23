...
public class GuideActivity extends AppCompatActivity {
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            GuidePageFragment tp = null;
            switch (position) {
                case 0:
                    tp = GuidePageFragment.newInstance(R.layout.guide_page3);
                    break;
                case 1:
                    tp = GuidePageFragment.newInstance(R.layout.guide_page1);
                    break;
                case 2:
                    tp = GuidePageFragment.newInstance(R.layout.guide_page2);
                    break;
                case 3:
                    tp = GuidePageFragment.newInstance(R.layout.guide_page4);
                    break;
                case 4:
                    tp = GuidePageFragment.newInstance(R.layout.guide_page5);
                    break;
                case 5:
                    tp = GuidePageFragment.newInstance(R.layout.guide_empty);
            }
    ...
    public class CrossfadePageTransformer implements ViewPager.PageTransformer {
        ...
        public void transformPage(View page, float position) {
            ...
            View welcomeImage01 = page.findViewById(R.id.welcome_03);
            View welcomeImage02 = page.findViewById(R.id.welcome_01);
            View welcomeImage03 = page.findViewById(R.id.welcome_02);
            ...
            if (position <= -1.0f || position >= 1.0f) {
                ...
                if (welcomeImage04 != null) {
                    ViewHelper.setTranslationX(welcomeImage04, pageWidth / 2 * position);
                    ViewHelper.setAlpha(welcomeImage04, 1.0f - Math.abs(position));
                }

                if (welcomeImage05 != null) {
                    ViewHelper.setTranslationX(welcomeImage05, pageWidth / 2 * position);
